...
def FullOTA_InstallEnd(info):
  info.script.AppendExtra('if (getprop("ro.boot.mid") == "2PZF10000") then')
  ...
  info.script.AppendExtra('if (getprop("ro.boot.mid") == "2PZF30000") then')
  info.script.Print("This is a dtwl device - renaming radio props")
  info.script.AppendExtra('mount("ext4", "EMMC", "/dev/block/bootdevice/by-name/system", "/system", "");')
